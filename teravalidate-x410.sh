...
RESULTSFILE="./$LOGDIR/teravalidate_x410_results_$DATE"


OUTPUT=hdfs://isilon/data/teragen/${SIZE}-terasort-output
REPORT=hdfs://isilon/data/teragen/${SIZE}-terasort-report
